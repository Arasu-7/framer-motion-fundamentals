    ...
    <div className="w-[80%] flex">
      {images.map((image, index) => (
        ...
        >
          ...
          <motion.div
            className="absolute inset-0 flex items-center justify-center text-white transition-opacity duration-300 bg-black bg-opacity-50 opacity-0 cursor-pointer hover:opacity-50"
